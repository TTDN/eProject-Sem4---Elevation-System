...
<body style="background-color: rgba(230, 191, 198, 0.06);">
	<div id="fo1">
		<div id="fo2">
			<h1 style="color: rgba(240, 12, 12, 1);">Update Admin</h1>
			<s:form action="upSPP" method="post">
				<table id="tb">
					<tr class="trtr">
						<td><s:hidden name="ad.iduser"></s:hidden></td>
				...
				<s:submit id="btn" cssClass="btn btn-success" value="Update"></s:submit>
			</s:form>
		</div>
	</div>
</body>
